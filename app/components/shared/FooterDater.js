   ...
   return <>
      <div className="container mx-auto">
         <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
            <Link href="/" className="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-inherit mb-6">
               <svg width="113" height="25" viewBox="0 0 300 147.69222502070932" className="looka-1j8o68f">
                    <defs id="SvgjsDefs1082"></defs>
                    <g id="SvgjsG1083" featurekey="X3o6dM-0" transform="matrix(8.266946761515438,0,0,8.266946761515438,-0.6613541247064008,-59.02601454141336)" fill="#ec4899">
            ...
            <div className="grid grid-cols-3 justify-between gap-4 mb-6">
                 <ul>
                   <h6 className="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-blue-gray-900 mb-4">Company</h6>
                    <li>
                       <Link href={"/contact"} className="text-sm text-gray-600 uppercase">Contact</Link>
                    </li>
                 </ul>
                 <ul>
                   <h6 className="block antialiased tracking-normal font-sans text-base font-semibold leading-relaxed text-blue-gray-900 mb-4">legal</h6>
                    <li>
                      <Link href={"/privacy-policy"} className="text-sm text-gray-600 uppercase">Privacy Policy</Link>
                    </li>
                    <li>
                      <Link href={"/terms-of-service"} className="text-sm text-gray-600 uppercase">Terms of service</Link>                 
                    </li>
                 </ul>
            </div>
         </div>
      </div>
      <div className="container mx-auto flex justify-center p-2 border-t">
        <p className="text-zinc-600 text-lg">Copyright  &copy; {currentYear} goosipchat.in</p>
      </div>
    </>
}